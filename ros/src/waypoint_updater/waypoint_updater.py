...
class WaypointUpdater(object):
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            if self.pose and self.base_waypoints:
                ...
                closest_waypoint_ind = self.get_closest_waypoint_ind()
                self.publish_waypoints(closest_waypoint_ind)
            rate.sleep()
    ...
    def publish_waypoints(self, closest_ind):
        ...
        lane.waypoints = self.base_waypoints.waypoints[closest_ind:closest_ind + LOOKAHEAD_WPS]
